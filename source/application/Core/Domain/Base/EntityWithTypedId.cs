...
namespace Intrigma.DonorSpace.Core.Domain.Base
{
    ...
    public abstract class EntityWithTypedId<TId> : ComparableObject, IEntityWithTypedId<TId>
    {
        ...
        /// </summary>
        [XmlIgnore]
        public virtual TId Id { get; internal protected set; }
        ...
        ///     a Customer is transient if its Id is 0.  It's virtual to allow EF-backed 
        ...
        protected override IEnumerable<PropertyInfo> GetTypeSpecificSignatureProperties()
        {
            return
                GetType().GetProperties().Where(
                    p => Attribute.IsDefined((MemberInfo)p, typeof(DomainSignatureAttribute), true));
        }
