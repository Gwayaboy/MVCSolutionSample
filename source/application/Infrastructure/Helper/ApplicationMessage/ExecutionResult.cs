...
namespace Intrigma.DonorSpace.Infrastructure.Helper.ApplicationMessage
{
    // <summary>
    ...
    public class ExecutionResult :IExecutionResult
    {
        ...
        public String ErrorMessages
        {
            ...
            {
                return
                    string.Concat(Errors.Select(x => string.Format("{0} : {1}\n", x.Key, string.Concat(x.Value.Messages))));
            }
        }
        ...
        public override string ToString()
        {
            ...
            if (!IsSuccessFull)
            {
                ...
                {
                    sb.AppendFormat("{0}: ", error.Key);
                    sb.AppendLine();
                    foreach (var message in error.Value.Messages)
                    {
